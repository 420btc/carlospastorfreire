...
const projects: ProjectType[] = [
  ...
  },
  {
    ...
    "description": "Mi propia web personal para la venta de servicios de grabación con drones FPV en la Costa del Sol, Málaga. Secciones de contacto, meteorología con datos reales, servicios, proyectos y equipo disponible.",
    "image": "/freirefpv.png",
  ...
  },
  {
    ...
    "description": "Plataforma web diseñada para registrar, analizar y explorar los sueños desde una perspectiva inspirada en las teorías psicoanalíticas de Sigmund Freud. Incluye un diccionario de símbolos oníricos y la capacidad de llevar un historial detallado con IA personal.",
    "image": "/aidreamer.png",
